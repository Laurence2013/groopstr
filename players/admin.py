...
admin.site.register(Player_Week_table)
...
admin.site.register(Goalkeeper_table)
admin.site.register(Defender_table)
admin.site.register(Midfielder_table)
admin.site.register(Striker_table)
