...
class Fixtures_and_Weeks:
    ...
    def week_fixture_table_00(self):
        Week_table.objects.create(id = 11, week_no = 1, date_updated = '2018-08-17 20:44:40', end_date = '2018-08-11', start_date = '2018-08-05', has_this_week_passed = 0)
        Week_table.objects.create(id = 12, week_no = 2, date_updated = '2018-08-17 20:44:46', end_date = '2018-08-18', start_date = '2018-08-12', has_this_week_passed = 0)
        Week_table.objects.create(id = 13, week_no = 3, date_updated = '2018-08-17 20:44:50', end_date = '2018-08-26', start_date = '2018-08-19', has_this_week_passed = 0)
        ...
        return Week_table.objects.all().values('id','week_no','start_date','end_date','has_this_week_passed'), Fixtures_table.objects.all().values('id','fixture','competition','date_of_game','week_no_id')
    ...
    def week_table_for_admin(self):
        Week_table.objects.create(id = 13, week_no = 8, date_updated = '2018-08-17 20:44:50', end_date = '2018-08-26', start_date = '2018-08-19', has_this_week_passed = 0)
