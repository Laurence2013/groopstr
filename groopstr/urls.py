...
urlpatterns = [
    ...
    path('admin_update/stats_search/', SetAllStatsTable.as_view(), name='stats_search'),
    path('admin_update/stats_search/get_all_stats/', GetAllStatsTable.as_view(), name='get_all_stats'),
